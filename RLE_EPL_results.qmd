...
# write results
write.csv(riv_results_type_sa, file = "outputs/riv_results_type.csv")
write.csv(riv_results_sa_for_integration, file = "outputs/riv_results_for_integration.csv")
write.csv(unlucky_wide_sa, file = "outputs/riv_unluckies.csv")
