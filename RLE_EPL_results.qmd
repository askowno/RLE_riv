...
RLE <- RLE %>%
  select(RIVTYPE, RLE_18, RLE_24, A3sa_18, A3sa_24) %>%
  rename(RLE18 = RLE_18, RLE24 = RLE_24, RLEsa18 = A3sa_18, RLEsa24 = A3sa_24)
EPL <- EPL %>%
...
# write results
write.csv(riv_results, file = "outputs/RLE_EPL_riv_results.csv")
```
