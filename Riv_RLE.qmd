...
# add in change in PES for B1i ongoing decline evidence (PES ABC DD extent decline > 1%)  
...
# PES EF ~ 90%-100% severity; DEF ~ 70%-100% severity; CDEF ~ 50%-100% severity
    ...
    mutate(D3_24 = case_when( prp24_ef >= 0.9 ~ "CR", 
                                 ...
                                 prp24_ef  >= 0.5 | prp24_def >=0.7 | 
                                                    prp24_cdef >= 0.9 ~ "VU", 
                                 TRUE ~ "LC")) %>%
# add B1i using declining PES trend as evidence of ongoing decline (calculated above in pes_decline)
